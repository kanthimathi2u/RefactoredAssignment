...
public class Rules {
	...
	private static final Character[] NonRepeatingRomanNumber = {'D', 'L', 'V'};
	private static final Character[] RepeatingRomanNumber = {'I','V','X','M'};
	...
	public static void checkLiteralCountValidity(Character CurrentLiteral){
		if(checkIfLiteralPresent(NonRepeatingRomanNumber, CurrentLiteral)){
